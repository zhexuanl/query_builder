...
- [x] 2.2 Configure the library package surface as `@query-builder/ui`

## 3. Theme Foundation

- [x] 3.1 Configure Tailwind-based styling, CSS tokens, and the light-only shell theme foundation
