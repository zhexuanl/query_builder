...
Translate a `QuerySpec` DSL value object into dialect-specific SQL and bound parameters using SQLAlchemy Core, enforcing catalog integrity and exposing a testable port contract.
