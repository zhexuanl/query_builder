# queryspec-draft-contract Specification

## Purpose
Define the frontend library contract for local QuerySpec draft state, typed consumer events, and demo-only verification surfaces before backend execution or persistence is introduced.
## Requirements
