...
Provide a pure-Python codec for round-tripping `QuerySpec` value objects through plain dicts and JSON, with no dependency on SQLAlchemy, Pydantic, or any infrastructure framework.
